<div align="center">
 <h1><b>Microverse Math Magician Project</b></h1>
</div>
# 📗 Table of Contents
...
```sh
  git clone https://github.com/JOdiemo/Math-Magicians.git
  cd Math-Magicians
```
...
Feel free to check the [issues page](https://github.com/JOdiemo/Math-Magicians/issues).
